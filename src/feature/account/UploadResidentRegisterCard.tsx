...
const UploadResidentRegisterCard = ({ route }: any) => {
    const { TWO_FACE_IMAGE, ENUM_MEMBER_ID_TYPE } = staticValue;
    const { navigateFrom = '' } = route?.params || {};
    const { showModalCard, frontImage, backImage, disable } = useTakePhotoCard(ENUM_MEMBER_ID_TYPE.ARC, TWO_FACE_IMAGE);
    const handleUpdateButton = () => {
        push(TAB_NAVIGATION_ROOT.ACCOUNT_ROUTE.CONFIRM_CARD, {
            doubleImage: true,
            image: { frontImage, backImage },
            IDType: ENUM_MEMBER_ID_TYPE.ARC,
    ...
    return (
        <View style={styles.flex1}>
            ...
            <ScrollView style={styles.content}>
                <StyledText i18nText="verifyIdentity.residentRegisterCardSubTitle" customStyle={styles.subTitle} />
                ...
                <View style={styles.noteContainer}>
                    ...
                    <ItemNoteCard text="verifyIdentity.residentRegister.note1" />
                    <ItemNoteCard text="verifyIdentity.residentRegister.note2" />
                </View>
                <StyledButton
                    disabled={disable}
                    onPress={handleUpdateButton}
                    title="verifyIdentity.residentRegister.buttonConfirm"
...
export default UploadResidentRegisterCard;
