...
const UploadHealthCard = ({ route }: any) => {
    ...
    const { showModalCard, frontImage, backImage, disable } = useTakePhotoCard(
        ENUM_MEMBER_ID_TYPE.HEALTH_INSURANCE,
        TWO_FACE_IMAGE,
    );
    const handleUpdateButton = () => {
        push(TAB_NAVIGATION_ROOT.ACCOUNT_ROUTE.CONFIRM_CARD, {
            ...
            IDType: ENUM_MEMBER_ID_TYPE.HEALTH_INSURANCE,
    ...
    return (
        <View style={styles.flex1}>
            ...
            <ScrollView style={styles.content}>
                <StyledText i18nText="verifyIdentity.healthCardSubTitle" customStyle={styles.subTitle} />
                ...
                <View style={styles.noteContainer}>
                    ...
                    <ItemNoteCard
                        text="verifyIdentity.health.note"
                        dotCustomStyle={styles.dotStyle}
                        noteCustomStyle={styles.noteCustomStyle}
                    />
                </View>
                <StyledButton
                    disabled={disable}
                    onPress={handleUpdateButton}
                    title="verifyIdentity.health.buttonConfirm"
...
const styles = ScaledSheet.create({
    ...
    dotStyle: {
        backgroundColor: Themes.COLORS.borderInputError,
    },
    noteCustomStyle: {
