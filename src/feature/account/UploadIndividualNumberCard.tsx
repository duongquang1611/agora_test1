...
const UploadIndividualNumberCard = ({ route }: any) => {
    const { DEFAULT_VALUE, ENUM_MEMBER_ID_TYPE } = staticValue;
    const { navigateFrom = '' } = route?.params || {};
    const { showModalCard, frontImage, disable } = useTakePhotoCard(ENUM_MEMBER_ID_TYPE.ID_CARD);
    const handleUpdateButton = () => {
        push(TAB_NAVIGATION_ROOT.ACCOUNT_ROUTE.CONFIRM_CARD, {
            doubleImage: false,
            image: { frontImage },
            IDType: ENUM_MEMBER_ID_TYPE.ID_CARD,
    ...
    return (
        <View style={styles.flex1}>
            ...
            <ScrollView style={styles.content}>
                <StyledText i18nText="verifyIdentity.individualNumberCardSubTitle" customStyle={styles.subTitle} />
                ...
                <View style={styles.noteContainer}>
                    ...
                    <ItemNoteCard text="verifyIdentity.individualNumber.note1" />
                    <ItemNoteCard text="verifyIdentity.individualNumber.note2" />
                </View>
                <StyledButton
                    disabled={disable}
                    onPress={handleUpdateButton}
                    title="verifyIdentity.individualNumber.buttonConfirm"
...
export default UploadIndividualNumberCard;
