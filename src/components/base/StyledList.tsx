...
import { FlatList, FlatListProps, RefreshControl, View, StyleProp, ViewStyle, TextStyle } from 'react-native';
...
interface Props extends FlatListProps<any> {
    ...
    customStyle?: any;
    noDataStyleText?: StyleProp<TextStyle>;
    noDataStyleContainerText?: StyleProp<ViewStyle>;
    emptyIcon: string;
    onLoadMore?(): void;
    ...
    function renderNoData() {
        ...
        return (
            <NoData
                ...
                customStyleText={props?.noDataStyleText}
                customStyleContainerText={props?.noDataStyleContainerText}
                loading={loading}
